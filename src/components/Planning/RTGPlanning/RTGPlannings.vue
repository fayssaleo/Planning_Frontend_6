<template>
  <v-row style="width: 100%; margin: 0 auto">
    <v-col cols="12">
      <h1>{{ getSelected_profile_group?.type.toUpperCase() }} Planning :</h1>
    </v-col>
    <v-col cols="1"></v-col>
    ...
    <v-col cols="4" style="width: 105% !important">
      <v-row>
        ...
        <v-col
          ...
          cols="12"
          @click="
            getShifPlanningById(shifts[0].id) != null
        ...
        <v-col
          ...
          cols="12"
          @click="
            getShifPlanningById(shifts[1].id) != null
        ...
        <v-col
          ...
          cols="12"
          @click="
            getShifPlanningById(shifts[2].id) != null
